...
static u8 memory[0x10000] = {
	[RPU_BACKGROUND_PAL   +  2] = 0xf0,0x8c,
	[RPU_TILES_BACKGROUND + 16] = 0b00000000,0b00111111,
	...
	[RPU_TILES_BACKGROUND + 32] = 0b11110000,0b00000000,
	...
	[RPU_TILES_BACKGROUND + 48] = 0b00000010,0b10101110,
	...
	[RPU_BACKGROUND_TL   + 7 * 16 + 7] = 1,
	[RPU_BACKGROUND_ATTR + 7 * 16 + 7] = 0b00000001,
	[RPU_BACKGROUND_TL   + 7 * 16 + 8] = 2,
	[RPU_BACKGROUND_ATTR + 7 * 16 + 8] = 0b00000001,
	[RPU_BACKGROUND_TL   + 8 * 16 + 7] = 3,
	[RPU_BACKGROUND_ATTR + 8 * 16 + 7] = 0b00000001,
	[RPU_BACKGROUND_TL   + 8 * 16 + 8] = 3,
	[RPU_BACKGROUND_ATTR + 8 * 16 + 8] = 0b00001001,
};
